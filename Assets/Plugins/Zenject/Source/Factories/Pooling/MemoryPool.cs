namespace Zenject
{
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TValue>, IFactory<TParam1, TValue>
    {
        ...
        protected virtual void Reinitialize(TParam1 reinitializeData, TValue item)
        {
            // Optional
        }
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TParam2, TValue>, IFactory<TParam1, TParam2, TValue>
    {
        ...
        TValue IFactory<TParam1, TParam2, TValue>.Create(TParam1 p1, TParam2 data)
        {
            return Spawn(p1, data);
        }
    }
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TParam2, TParam3, TParam4, TValue>, IFactory<TParam1, TParam2, TParam3, TParam4, TValue>
    {
        ...
        protected virtual void Reinitialize(TParam1 velocity, TParam2 damage, TParam3 p3, TParam4 p4, TValue item)
        {
            // Optional
        }
